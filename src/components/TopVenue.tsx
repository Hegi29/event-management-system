    ...
    return (
        <Card containerStyle={styles.card}>
            <ListItem.Accordion
                ...
                content={
                    <ListItem.Content>
                        <Text style={styles.title}><Icon name="apartment" type="material" size={24} color="#000" style={{ paddingRight: 5 }} />{TITLE_HOME_B}</Text>
                    </ListItem.Content>
                }
                isExpanded={expanded}
                onPress={() => {
            ...
            {/* <Text style={styles.title}><Icon name="trip-origin" size={24} color="#000" style={{ paddingRight: 5 }} />Top Venue</Text>
            <Card.Divider />
            {EVENT_LIST.map((item) => (
                <Card key={item.eventId} containerStyle={styles.eventCard}>
                    <Image source={{ uri: item.images[0] }} resizeMode='cover' style={styles.image} />
                    ...
                    <Text style={styles.province}>{item.province}</Text>
                    <Text style={styles.province}>{item.status}</Text>
                    <Button title="View Details" icon={<Icon name="trip-origin" size={24} color="#fff" style={{ paddingRight: 5 }} />} buttonStyle={styles.buttonColor} containerStyle={styles.button} />
                    <Text style={styles.submitDate}>Submitted on {item.submit_date}</Text>
                </Card>
            ))} */}
        </Card>
