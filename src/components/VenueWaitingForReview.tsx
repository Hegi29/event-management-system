...
type ListVenueProps = { data: any, totalItemRequest: number, handleShowMoreVenueWaiting: () => void };
...
const ListVenue = ({ data, totalItemRequest, handleShowMoreVenueWaiting }: ListVenueProps) => {
    ...
    return (
        <View style={{ padding: 0, width: 350 }}>
            ...
            {totalItemRequest > data.length && <Button title='Show More' buttonStyle={{ borderRadius: 13, marginTop: 15, width: '50%' }} containerStyle={{ alignItems: 'center' }} onPress={handleShowMoreVenueWaiting} />}
        </View>
    )
}

const ListItemContentBody = ({ data, totalItemRequest, handleShowMoreVenueWaiting }: any) => {
    return (
        <View style={{ padding: 0, width: 350 }}>
            {data.length > 0 && <ListVenue data={data} totalItemRequest={totalItemRequest} handleShowMoreVenueWaiting={handleShowMoreVenueWaiting} />}
            {data.length === 0 && <Text style={{ textAlign: 'center', fontWeight: 'semibold' }}>No Data</Text>}
        </View>
    )
}

const VenueWaitingForReview = ({ data, totalItemRequest, handleShowMoreVenueWaiting }: any) => {
        ...
        <Card containerStyle={styles.card}>
            ...
            >
                <ListItem containerStyle={styles.listItemBodyContainer}>
                    <ListItem.Content>
                        <ListItemContentBody data={data} totalItemRequest={totalItemRequest} handleShowMoreVenueWaiting={handleShowMoreVenueWaiting} />
                    </ListItem.Content>
                </ListItem>
            </ListItem.Accordion>
        </Card>
...
export default VenueWaitingForReview;
