...
import { Button, Card, CheckBox, Chip, Divider, Icon, Image, ListItem, Text } from "@rneui/themed";
        ...
        <View>
            ...
            <View style={{ paddingVertical: 10 }}>
                ...
                <View style={{
                    ...
                    <Button buttonStyle={{ width: 80, borderRadius: 10, backgroundColor: '#0D5B95' }} onPress={handleSubmit}>Submit</Button>
                </View>
            </View>
        </View>
    )
