...
import { CheckedImage, ExcelFileImage, ImageFileImage, QuestionFileImage, WarningFileImage } from "../../assets/images";
...
import { setProgressEnvironment } from "../../redux/reducers/answerSlice";
...
const HeadTab = () => {
    return (
        <View style={{ paddingHorizontal: 10 }}>
            <Text h4 style={styles.titleTab}>Security Section</Text>
...
const EnvironmentTab = ({ setIndex, isDraft, tipe, setSelectedSection, dataQuestions, setNoTabValid, allEvidenceList }: any) => {
    ...
    const setProgressAnswer = (value: number) => {
        dispatch(setProgressEnvironment(value))
    }
