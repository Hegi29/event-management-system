...
import { setProgressSafety } from "../../redux/reducers/answerSlice";
...
const SafetyTab = ({ setIndex, isDraft, tipe, setSelectedSection, dataQuestions, setNoTabValid, allEvidenceList }: any) => {
    ...
    const setProgressAnswer = (value: number) => {
        dispatch(setProgressSafety(value))
    }
