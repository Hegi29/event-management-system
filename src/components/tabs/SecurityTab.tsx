...
import { setProgressSecurity } from "../../redux/reducers/answerSlice";
...
const SecurityTab = ({ setIndex, isDraft, tipe, setSelectedSection, dataQuestions, setNoTabValid, allEvidenceList }: any) => {
    ...
    const setProgressAnswer = (value: number) => {
        dispatch(setProgressSecurity(value))
    }
