...
const HeadTab = () => {
    return (
        <View style={{ paddingHorizontal: 10 }}>
            <Text h4 style={styles.titleTab}>Environment Section</Text>
        </View>
    )
}
...
const EnvironmentTab = ({ dataQuestions, setIndex, setSelectedSection, allEvidenceList, createComment }: any) => {
    console.log("🚀 ~ EnvironmentTab ~ dataQuestions:", dataQuestions)
